 ...
 *
 */
public final class TapestryContextInformationControl extends PopupDialog
        ...
        IInformationControlExtension2, DisposeListener
{
    ...
    protected PatternMatcher fPatternMatcher;
    /**
    ...
    {
        super(window.getShell(), SWT.RESIZE, true, true, false, true, true, null, null);
        this.window = window;
    ...
    private String getText(Object element, TreeViewer treeViewer)
    {
    ...
    /*
     * @see
     * org.eclipse.jface.dialogs.PopupDialog#setTabOrder(org.eclipse.swt.widgets
     * .Composite)
     */
    @Override
    ...
    protected TreeViewer createTreeViewer(Composite parent)
    {
        ...
        treeViewer.setContentProvider(new TapestryContextContentProvider(window, tapestryContext));
