...
public class Orderer<T>
{
    ...
    private final Map<String, DependencyNode<T>> dependencyNodesById = new CaseInsensitiveMap<DependencyNode<T>>();
    ...
    private Collection<DependencyNode<T>> findDependencies(String sourceId, String patternList)
    {
        ...
        for (String id : dependencyNodesById.keySet())
        {
            ...
            if (matcher.matches(new TapestryService(null, new ServiceDefinition().setId(id), null)))
            {
    ...
    private Matcher buildMatcherForPattern(String patternList)
    {
        ...
        {
            IdentityIdMatcher matcher = new IdentityIdMatcher(pattern.trim());
